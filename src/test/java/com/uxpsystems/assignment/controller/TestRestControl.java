...
public class TestRestControl {
	...
	public void getUsersTest() {		
		when(repo.findAll()).thenReturn(Stream 
				.of(new UserEntity(1,"Lokesh", "Gupta", "Activated"), new UserEntity(5,"Deja", "Vu", "Deactivated"), new UserEntity(8,"Shahid", "Ans12", "Activated"), new UserEntity(3,"Caption", "America", "Activated")).collect(Collectors.toList()));
